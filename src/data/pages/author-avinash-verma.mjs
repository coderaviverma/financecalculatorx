export default {
  ...
  bodyHtml: `
    ...
    <p>You can verify my work directly: this site's complete source code — every calculator, the shared math library and the automated test suite — is public at <a href="https://github.com/coderaviverma/financecalculatorx" rel="noopener">github.com/coderaviverma/financecalculatorx</a>. My broader open-source profiles are on <a href="https://github.com/coderaviverma" rel="noopener">GitHub</a> and <a href="https://gitlab.com/coderaviverma" rel="noopener">GitLab</a>, and my professional profile is on <a href="https://www.linkedin.com/in/avinashverma89/" rel="noopener">LinkedIn</a>.</p>
