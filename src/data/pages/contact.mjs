export default {
  slug: "contact",
  title: "Contact",
  metaTitle: "Contact Finance Calculator X",
  metaDescription:
  ...
  bodyHtml: `
    ...
    <ul>
      <li><strong>Reporting a suspected error:</strong> the calculator's name (or its web address), the exact inputs you entered, the result you got, and the result you expected. Every calculator has a <em>Copy link</em> button that captures your inputs in a shareable URL — pasting that link is the single most useful thing you can send.</li>
      <li><strong>Suggesting a calculator:</strong> what decision it would help with, and what inputs and outputs you'd expect.</li>
