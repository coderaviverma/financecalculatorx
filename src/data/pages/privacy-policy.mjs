export default {
  ...
  bodyHtml: `
    ...
    <p>After opt-in, GA4 helps us understand aggregate page use and navigation. Before sending a page location or referrer, the site removes query strings and fragments. Custom events contain only coarse interaction labels or counts; they do not contain calculator inputs, saved scenarios, shared-link state or raw search terms. Google may still process information such as an online identifier, device/browser details and approximate location after you consent. Google's handling is described at <a href="https://policies.google.com/technologies/partner-sites" rel="noopener">policies.google.com/technologies/partner-sites</a>.</p>
