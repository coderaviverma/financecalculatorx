...
<p>The <strong>APR (annual percentage rate)</strong> is a disclosure figure, not a rate the lender charges. It restates the loan's total mandatory cost — interest <em>plus required fees</em> — as a single yearly rate, computed on the money you actually walked away with. The logic: if you're charged an $800 origination fee on a $20,000 loan, you effectively borrowed $19,200 but repay as if you borrowed $20,000. The APR is the interest rate that would produce your exact payments on that smaller, real amount. Fees make APR higher than the note rate; no fees make them equal. APR can never be lower.</p>
...
<p><strong>Loan B</strong> — payment on $20,000 at 5.9% is <strong>$385.73</strong>, about $4.66 less per month. But the $800 fee means you only received $19,200. Total cost: $23,143.60 in payments + $800 = <strong>$23,943.60 — $520.39 more than Loan A</strong>.</p>
<p>Loan B's APR is the rate at which 60 payments of $385.73 are worth exactly $19,200 today. Solving for that rate gives <strong>7.61%</strong>. So the honest comparison is 6.4% vs 7.61% — and Loan A wins, despite the higher sticker rate.</p>
</div></div>
...
<p><strong>Short holding periods.</strong> An upfront fee is paid once, but APR spreads it across the whole term. Repay early and the fee is concentrated into fewer years, so the true annual cost rises above the disclosed APR. Take Loan B again: if you repay it after 24 months (remaining balance $12,698.13), the effective annual cost of those two years — 24 payments plus the payoff, measured against the $19,200 received — works out to <strong>8.52%</strong>, well above the 7.61% full-term APR. This is why mortgage points are usually poor value if you might sell or refinance within a few years: the fee is sunk on day one, the rate saving needs years to repay it.</p>
<p><strong>Different terms.</strong> APR is an annualized <em>rate</em>, not a total. A 36-month loan and a 72-month loan at the same APR are radically different commitments — the longer one accrues that rate over twice as many years and costs far more in total interest. APR ranks loans of the <em>same</em> amount and term; across different terms, compare total cost and monthly payment side by side instead.</p>
<p><strong>Mortgages deserve special care.</strong> Home loans carry the largest fee stacks — origination, points, and various closing costs — so the rate-to-APR gap is usually widest there, and the short-holding-period problem bites hardest because few 30-year mortgages live for 30 years. For adjustable-rate mortgages, the disclosed APR also embeds an assumption about where the rate goes after the fixed period, which makes it closer to a forecast than a fact. Use the <a href="/mortgage-calculator/">Mortgage Calculator</a> to see the payment mechanics, but evaluate fees against the years you realistically expect to keep the loan.</p>
...
<p>Notice the symmetry: on loans, the headline number (note rate) understates the true cost, and APR corrects it upward. On savings, the headline number (nominal rate) understates the true yield, and APY corrects it upward — which is why banks quote APR reluctantly on loans and APY enthusiastically on deposits. In both cases the corrected figure is the comparable one. The compounding mechanics behind APY are worked through in <a href="/guides/how-compound-interest-works/">how compound interest works</a>.</p>

<h2>How to use each number</h2>
<ul>
<li><strong>Budgeting?</strong> Use the interest rate — it (with the term) determines your monthly payment. The <a href="/loan-calculator/">Loan Calculator</a> gives you payment and schedule from it.</li>
...
<p>Disclosure rules require lenders in most countries to state APR before you commit. It's a good number — honest by construction, hard to game — as long as you remember the one thing it assumes: that you'll still be paying this loan in its final month.</p>
`,
};
