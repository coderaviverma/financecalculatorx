...
<p>Consider this debt profile — $15,800 total, $380 in combined minimums, and $300/month available beyond the minimums (a $680 total budget):</p>
...
<li><strong>Small debts at high rates</strong>: the happy case — both rules pick the same targets and the debate dissolves.</li>
</ul>
...
<p>Two adjacent tools deserve mention. A <strong>0% balance transfer</strong> temporarily reorders the math — a transferred balance drops to the bottom of the avalanche list until the promotional period nears its end, at which point it jumps back up at its post-promo rate; transfer fees (typically 3–5% upfront) should be weighed like any other fee. And <strong>consolidation</strong> is a different decision entirely — replacing several rates with one — which should be evaluated against your current plan's total interest, not its monthly payment; the <a href="/loan-calculator/">Loan Calculator</a> can model any consolidation offer for comparison. How rate and balance interact to produce interest is covered in <a href="/guides/how-loan-interest-works/">how loan interest works</a>.</p>

<h2>What both strategies quietly assume</h2>
<div class="callout warn"><span class="c-title">The plan is only as good as its assumptions</span>
<p>Both simulations assume <strong>no new borrowing</strong> — a cleared card that gets reloaded resets the plan and adds the new interest on top. They assume <strong>minimums stay constant</strong>, while real card minimums often shrink with the balance (which stretches minimum-only timelines even longer than shown). They assume <strong>rates stay fixed</strong>, while card APRs are typically variable and promotional 0% rates expire. And they assume the extra $300 survives contact with real budgets every single month.</p></div>
...
<li>Minimums themselves unaffordable, or balances growing at minimums? That's not a strategy problem — nonprofit credit counseling or lender hardship programs come first.</li>
<li>Budget not yet defined? Start there: the <a href="/budget-calculator/">Budget Calculator</a> establishes what the "extra" actually is — a plan built on an imaginary surplus fails by month three.</li>
