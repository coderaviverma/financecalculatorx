export default {
  ...
  bodyHtml: `
<p>Inflation is the only financial force that acts on every dollar you own, every year, without asking. It never shows up on a bank statement — your balance only ever goes up — yet it determines what that balance can actually buy. Most savings mistakes trace back to ignoring it: goals set in today's prices, "safe" accounts that quietly lose ground, retirement targets that look impressive until you deflate them. This guide covers the mechanics with computed numbers, because the effect is easy to acknowledge and hard to feel until you see it in figures.</p>

<h2>What inflation does to a fixed sum</h2>
<p>Purchasing power is what a unit of money can buy, and inflation is the rate at which that shrinks. At 3% annual inflation — close to the long-run US average — prices rise by a factor of 1.03 each year, compounding just like interest does. Divide any future balance by that factor, once per year, and you get its value in today's money.</p>
...
<p>Read the 30-year row again: cash held idle for three decades of 3% inflation loses almost 59% of what it can buy. Nothing dramatic happened in any single year — 3% is mild, barely noticeable month to month. The damage is entirely in the compounding, which is the subject of our companion guide on <a href="/guides/how-compound-interest-works/">how compound interest works</a>. Inflation is that same exponential machine pointed at you instead of for you, with one grim difference: your contributions can pause, but inflation never takes a year off.</p>
...
<p>The quick approximation "nominal minus inflation" is close but slightly flatters the result. Precisely, a 4% savings rate during 3% inflation gives 1.04 ÷ 1.03 − 1 = <strong>0.97% real</strong> — not the 1.00% the subtraction suggests. Small difference in one year; over decades the exact formula keeps you honest.</p>
...
<h2>Set goals in real terms, or the plan quietly breaks</h2>
