...
<ul>
<li><strong>Same amount, same purpose.</strong> Quotes for $18,000 and $20,000 are not comparable — rates and fees both shift with size.</li>
...
<li><strong>Same term where possible.</strong> As shown below, differing terms can make a worse loan look better on every easy metric. If a lender only offers 48 months against another's 60, note it — that difference needs special handling.</li>
</ul>
<p>A practical note on shopping itself: credit bureaus generally treat multiple inquiries for the same loan type within a short window (commonly 14–45 days, depending on the scoring model) as a single event of rate shopping. Compressing your quote-gathering into a couple of weeks protects both comparability and your credit score.</p>
...
<p>The annual percentage rate exists precisely for this comparison: it folds mandatory fees into the rate, expressing the loan's cost as if the fees were interest. Two same-term offers can be ranked by APR alone, which is why regulators require its disclosure — and why the number in large font is usually the interest rate instead. The mechanics live in our guide to <a href="/guides/apr-vs-interest-rate/">APR vs interest rate</a>.</p>
...
<div class="example-block"><div class="ex-head">$20,000 over 60 months: Offer A — 8.9%, no fee vs Offer B — 7.4%, $500 origination fee</div><div class="ex-body">
...
<p><strong>Verdict held to term:</strong> B wins by $363 despite the fee — the rate advantage of $14.39/month outlasts the $500 head start A gets.</p>
<p><strong>Break-even:</strong> B's fee is repaid by its lower payments after 500 ÷ 14.39 ≈ <strong>35 months</strong>. Clear the loan before month 35 — payoff, refinance, selling the car — and A was actually the cheaper loan.</p>
</div></div>
...
<h2>Step 5: Negotiate — quotes are opening bids</h2>
<p>Loan pricing has margin in it, and written competing offers are the strongest ordinary-consumer negotiating tool that exists. A concrete better offer from a comparable lender gives the first lender something specific to beat, and matching or beating it costs them less than losing the loan. Credit unions and smaller banks frequently beat headline rates from large lenders; your existing bank may apply relationship discounts it never advertises until asked. The script is short: "Lender B has offered 7.4% with a $500 fee — can you beat $24,489 all-in over 60 months?" Note the framing in totals, not rates: it prevents the counter-offer from winning on one number while losing on another. A quarter-point concession on the case-study loan is worth roughly $140; five minutes of asking is well paid at that rate.</p>
...
<li><strong>Insurance add-ons pushed at signing</strong> — credit life or payment-protection policies are routinely overpriced and quietly financed into the loan; declining them is normally your right, and any "mandatory" insurance belongs in the fee comparison above.</li>
