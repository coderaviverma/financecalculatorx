export default {
  slug: "lump-sum-vs-monthly-investing",
  title: "Lump Sum vs Monthly Investing",
  metaTitle: "Lump Sum vs Monthly Investing — Which Wins?",
  metaDescription:
    "The math says invest a lump sum early; the psychology often says spread it out. What the numbers show, when averaging in makes sense, and how to decide.",
  description:
  ...
  bodyHtml: `
<p>You have money to invest and a choice to make: put it all in now, or feed it in gradually. It is one of the oldest arguments in personal finance, and it stays alive because both sides are half right. The arithmetic clearly favors investing earlier. The psychology of holding on through a bad stretch clearly favors whatever approach you can actually stick with. This guide works through the math with real numbers, then gives the honest case for each side and a framework for choosing.</p>

<h2>The core math: earlier money compounds longer</h2>
<p>Compounding rewards time in the market more than anything else. A dollar invested today earns returns for the entire horizon; a dollar invested in year nine earns returns for one year. Spreading a fixed sum over time therefore leaves most of it on the sidelines for most of the period — and that has a price you can calculate.</p>
...
<p>The gap is not a quirk of the numbers chosen. At any positive expected return, deploying sooner has a higher expected outcome, and the gap widens with higher returns and longer delays. This is the same force explained in our guide to <a href="/guides/how-compound-interest-works/">how compound interest works</a> — growth is back-loaded, so the early years you skip are the ones that would have mattered most by the end.</p>

<div class="table-scroll"><table>
<thead><tr><th>Strategy for $24,000</th><th>How it is deployed</th><th>Value after 10 years at 8%</th><th>Total growth</th></tr></thead>
<tbody>
<tr><td>Lump sum now</td><td>All invested in month 1</td><td>$53,271</td><td>$29,271</td></tr>
<tr><td>Staged over 12 months</td><td>$2,000/month for one year, then held</td><td>$51,033</td><td>$27,033</td></tr>
<tr><td>Spread over the full decade</td><td>$200/month for 10 years</td><td>$36,589</td><td>$12,589</td></tr>
</tbody>
</table></div>

<p>Notice the middle row: averaging in over a single year gives up only about $2,238 of the expected outcome, while spreading the same money across the whole decade gives up nearly $17,000. If you choose to average in, the schedule matters — a short, fixed window keeps most of the mathematical advantage.</p>

<h2>What dollar-cost averaging actually buys you</h2>
<p>Dollar-cost averaging (DCA) — investing a fixed amount at regular intervals — does not raise your expected return. What it changes is the <em>distribution</em> of outcomes around that expectation, and it addresses a specific fear: putting everything in the day before a fall.</p>
<p>Invest a lump sum and your entry price is a single point — whatever the market happened to cost that day. Average in over twelve months and your entry price is the average of twelve points. You will never buy everything at the top, and you will never buy everything at the bottom. In a market that falls after you start, DCA leaves you better off, because your later purchases happen at lower prices. In a market that rises — which is what markets have done more often than not over long stretches, and the very reason you are investing at all — DCA leaves you worse off, because your later purchases happen at higher prices.</p>
<p>So the honest framing is this: DCA is a form of insurance. You pay a premium (a lower expected outcome) to reduce a specific risk (a painful entry point). Insurance is not irrational — people buy it on their homes every year. The question is whether the premium is worth it to you, and whether the alternative is actually worse.</p>
