export default {
  ...
  sections: {
    howToHtml: `
      ...
      <ul>
        <li><strong>Loan amount</strong> — just the borrowed figure. If you're still working out the price/down-payment split, the <a href="/mortgage-calculator/">full mortgage calculator</a> handles that along with taxes and PMI.</li>
    ...
    explanationHtml: `
      ...
      <p>Term is the other lever, and it trades monthly comfort against lifetime cost. The same $300,000 at 6.5% costs $1,896.20/month over 30 years but $2,613.32 over 15 — $717 more each month. In exchange, total interest collapses from $382,633 to $170,398. One number captures the whole 15-vs-30 decision: the shorter term saves about <strong>$212,235</strong> here.</p>
      <p>Keep in mind the payment a lender actually collects will be higher once property tax, insurance and possibly PMI are escrowed on top. Use this tool to compare loans; use the full mortgage calculator to budget the complete monthly outlay.</p>`,
    formulaHtml: `
  ...
  faq: [
    ...
    },
    {
      ...
      aHtml: `<p>Yes — that's the core use. Take the loan amount from your pre-approval letter and the quoted rate, and check that the resulting P&amp;I payment fits your budget with room for tax, insurance and maintenance on top. Lenders approve against gross income ratios, which routinely allows more than is comfortable to actually pay.</p>`,
    },
    {
      q: "Why show payoff date if there's no start date input?",
      aHtml: `<p>The payoff date is projected from today, assuming the first payment is due next month — good enough for planning. If you want a schedule anchored to a specific first-payment month, with every payment dated, the <a href="/mortgage-amortization-calculator/">mortgage amortization calculator</a> does exactly that.</p>`,
    },
  ],
};
