  ...
  sections: {
    ...
    exampleHtml: `
      <div class="example-block"><div class="ex-head">Example: $1,000/month for 10 years vs $120,000 on paper</div><div class="ex-body">
        ...
        <p>PV = 1,000 × 90.0735 = <strong>$90,073.45</strong> — 75.1% of the $120,000 nominal total. Discounting quietly removes $29,926.55.</p>
        <p>Decision rule: a lump-sum buyout offer above $90,073 beats the payments if 6% genuinely reflects what you'd earn on the money; an offer of, say, $80,000 — which might sound generous against "$120,000 over time" — is actually about $10,000 short.</p>
      </div></div>`,
    factorsHtml: `
      <ul>
