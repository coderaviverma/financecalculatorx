export default {
  ...
  sections: {
    howToHtml: `
      ...
      <ul>
        <li><strong>Extra monthly payment</strong> — a recurring amount on top of the required payment, applied straight to principal.</li>
        <li><strong>One-time lump sum</strong> — a bonus or windfall, with a field for when you'd pay it (savings are larger the sooner it lands).</li>
    ...
    factorsHtml: `
      <ul>
        ...
        <li><strong>Rate.</strong> Your note rate is the guaranteed return on every prepaid dollar. At 6–7% prepaying competes well with bonds; at 3% it competes poorly with most alternatives, including high-yield savings.</li>
