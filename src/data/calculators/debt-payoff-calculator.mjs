export default {
  ...
  sections: {
    ...
    explanationHtml: `
      <h2>Snowball vs avalanche — what actually differs</h2>
      ...
      <p>The honest takeaway from running real numbers: for many debt profiles the strategies differ by tens of dollars per month of effort, not thousands. When the gap is small, pick the one that keeps you motivated. When one debt's rate towers over the rest — payday loans, many credit cards — avalanche's advantage grows and is usually worth taking. This calculator's job is to show you the actual size of the gap for <em>your</em> debts, so the choice is informed rather than ideological.</p>`,
    formulaHtml: `
      <p>There's no closed-form formula for multi-debt payoff — the calculator runs a month-by-month simulation, the same way your statements will unfold:</p>
    ...
    exampleHtml: `
      <div class="example-block"><div class="ex-head">Example: three debts, $25,000 total, $300/month extra</div><div class="ex-body">
        ...
        <p><strong>Snowball</strong> order: personal loan → credit card → car loan. Also 33 months, but <strong>$5,307.68</strong> interest — $534.24 more, in exchange for the first paid-off account arriving sooner.</p>
    ...
    limitationsHtml: `
      <ul>
        <li>APRs are treated as <strong>fixed</strong>; credit-card rates are typically variable and can change with the market or a missed payment. Promotional 0% periods that later jump aren't modeled — enter the post-promo rate for a conservative plan.</li>
        <li>Minimum payments are modeled as <strong>constant amounts</strong>. Real card minimums are often a percentage of the balance and shrink as you pay down, which stretches minimum-only payoff even longer than shown — the fixed-minimum assumption is the conservative, planning-friendly choice.</li>
