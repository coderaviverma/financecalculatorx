  ...
  sections: {
    howToHtml: `
      ...
      <ul>
        ...
        <li><strong>Current monthly payment</strong> should be only the part that services principal and interest. If your payment bundles escrow, insurance or service fees, subtract those first.</li>
        <li><strong>Extra monthly payment</strong> is optional; enter any amount you could add to see a second payoff line on the chart and the interest it avoids.</li>
      </ul>
    ...
    exampleHtml: `
      <div class="example-block"><div class="ex-head">Example: $14,000 left at 8.5%, paying $350/month</div><div class="ex-body">
        ...
        <p>Adding $50 a month shortens the payoff to <strong>41 months</strong> and trims interest to $2,146.17, with $373.51 saved for a modest change.</p>
      </div></div>`,
    factorsHtml: `
      <ul>
        ...
        <li><strong>Payment composition.</strong> If part of what you send covers escrow or fees, only the principal-and-interest portion drives the payoff math, so enter that portion, not the gross amount.</li>
      </ul>`,
    limitationsHtml: `
      <ul>
