export default {
  ...
  sections: {
    ...
    factorsHtml: `
      <ul>
        <li><strong>Rate gap.</strong> The old rule of thumb ("refinance at 1% below your rate") is a rough proxy for break-even; the honest test is fees ÷ monthly saving against how long you'll keep the loan. Smaller gaps can still work with low fees or large balances.</li>
  ...
  faq: [
    ...
    },
    {
      ...
      aHtml: `<p>No — the lender recovers the fees through a higher rate (typically 0.25–0.5% above the par rate), so you pay them monthly forever instead of once upfront. That trade actually favors you for short holding periods and works against you for long ones. To compare honestly here: enter 0 fees with the no-cost rate, then your quoted fees with the par rate, and compare lifetime rows.</p>`,
    },
    {
      q: "Should I roll the closing costs into the new loan?",
      aHtml: `<p>Rolling $5,000 into a 6.25% 25-year loan costs about $33/month and roughly $4,895 of interest on top of the fees themselves over the full term. It preserves your cash, which matters if reserves are thin — just include the rolled amount mentally when reading the lifetime comparison, since financed fees compound quietly.</p>`,
    },
  ],
};
