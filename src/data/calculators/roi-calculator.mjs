export default {
  ...
  sections: {
    howToHtml: `
      <p>Unlike the projection tools on this site, this one looks <strong>backward</strong>: you already know what went in and what came out, and the job is to measure it honestly.</p>
      <ul>
      ...
      <p>The table re-annualizes the same total return over 1, 2, 3, 5 and 10 years — worth a look once, because it shows how completely the holding period changes what a "40% gain" means.</p>`,
    explanationHtml: `
    ...
    exampleHtml: `
      <div class="example-block"><div class="ex-head">Example: $10,000 → $14,000 over 3 years</div><div class="ex-body">
        ...
        <p>Now include $500 of buying and selling costs: the base becomes $10,500, profit falls to $3,500, ROI to <strong>33.33%</strong> and the annualized rate to <strong>10.06%</strong>. One overlooked line item moved the result by nearly two points a year — which is the whole argument for gross-to-net honesty.</p>
      </div></div>`,
    factorsHtml: `
      <ul>
