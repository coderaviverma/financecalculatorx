export default {
  ...
  sections: {
    ...
    factorsHtml: `
      <ul>
        ...
        <li><strong>PMI at under 20%.</strong> Not a reason to panic: PMI typically runs 0.3–1.5% of the loan yearly and drops off at 20% equity. Sometimes buying sooner with PMI beats renting for four more years — the <a href="/rent-vs-buy-calculator/">rent vs buy calculator</a> quantifies that.</li>
      </ul>`,
    limitationsHtml: `
      <ul>
        ...
        <li>The home price is held constant over your saving runway — in rising markets the target moves as you approach it; consider re-running with an inflated price for long horizons.</li>
  ...
  faq: [
    ...
    },
    {
      ...
      aHtml: `<p>Lender origination, appraisal, title insurance, escrow deposits and prepaid taxes/insurance — typically 2–5% of the purchase price, due in cash at closing. This calculator assumes 3% ($10,500 on the default price). Sellers sometimes credit part of it in negotiation, and some lenders offer credits in exchange for a higher rate.</p>`,
    },
    {
      q: "Where should down payment savings live while I save?",
      aHtml: `<p>Somewhere boring and liquid: high-yield savings, money market funds or short CDs. Equities are a poor fit for a 2–5 year target with a fixed date — a 20% drawdown the year you plan to buy would set the plan back years. The interest-rate field models the safe-asset yield precisely because that's the appropriate vehicle.</p>`,
    },
    {
