export default {
  ...
  sections: {
    howToHtml: `
      ...
      <ul>
        <li><strong>Conservative (25/33)</strong> — a self-imposed margin many planners recommend.</li>
        <li><strong>Standard (28/36)</strong> — the classic qualifying ratios for conventional loans.</li>
        <li><strong>Aggressive (31/43)</strong> — closer to FHA-style ceilings; approval territory, comfort not included.</li>
      </ul>
    ...
    formulaHtml: `
      ...
      <p>The loan is then the present value of that payment stream at your rate — the amortization formula solved for the principal:</p>
    ...
    limitationsHtml: `
      <ul>
        ...
        <li>PMI is not added when the implied down payment is under 20% — it would reduce the affordable price slightly; treat sub-20%-down results as a touch optimistic.</li>
  ...
  faq: [
    ...
    },
    {
      ...
      aHtml: `<p>With light debts the front-end (housing share) binds, as in the defaults where $400 of debts still leaves back-end headroom. Once monthly debts exceed the gap between the two ratios times your gross income — 8% × $8,000 = $640 here — the back-end takes over. The calculator names the binding cap so you know whether paying off debts would actually raise your budget.</p>`,
    },
    {
