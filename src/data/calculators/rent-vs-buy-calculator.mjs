  ...
  sections: {
    ...
    factorsHtml: `
      <ul>
        ...
        <li><strong>Investment return.</strong> The higher the return your cash could earn elsewhere, the better renting looks. At 6% the renter's $92,000 earns $5,520 in year one alone — omitting this (as casual comparisons do) systematically flatters buying.</li>
