export default {
  ...
  popular: false,
  featured: true,
  jumpExplainLabel: "The 50/30/20 rule, honestly",
  ...
  sections: {
    howToHtml: `
      <p>Enter your monthly <strong>take-home</strong> income — after tax and payroll deductions, the amount that actually hits your account. Then set the three percentages:</p>
      <ul>
    ...
    factorsHtml: `
      <ul>
        <li><strong>Income level changes the right split.</strong> At $3,000 take-home the buckets are $1,500/$900/$600 and the 50% needs cap is genuinely hard; at $8,000 they're $4,000/$2,400/$1,600 and the 20% savings floor is genuinely soft. Adjust the percentages to the income, not the other way round.</li>
